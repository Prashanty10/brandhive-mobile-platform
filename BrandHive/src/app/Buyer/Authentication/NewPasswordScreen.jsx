      ...
      >
        ...
        <View style={styles.titleContainer}>
          ...
          <Text style={styles.subtitleText}>
            {"Create a new password. Ensure it's strong and secure."}
          </Text>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.successIconContainer}>
              <Ionicons name="checkmark-circle" size={wp("16%")} color={colors.success} />
            </View>
            <Text style={styles.modalTitle}>Success!</Text>
            <Text style={styles.modalMessage}>Password updated successfully!</Text>
            <TouchableOpacity
